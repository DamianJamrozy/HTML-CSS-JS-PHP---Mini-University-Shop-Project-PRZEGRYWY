...
<body style="overflow:hidden; color:white;">
	...
	<div id="container">
		<center><font size="4px">Edytuj grę:</font><br><br></center>
		...
		<div style="width:80%; margin:0 auto;">
			...
			<div class="center">
				...
				<select class="select" id="get_val1" name="Select_id_game" style="width:100%; height:40px;" required>  
				...
				<h3>Data premiery:</h3><br>
					...
					<br><br>
					<input type="submit" class="btn_buy" value="Edytuj" name="edit_game" style='width:100%;'><br><br>
				</form>
