...
<body style="overflow:hidden; color:white;">
		...
		<div id="container">
			<center><font size="4px">Zamówienia:</font><br><br></center>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
	...
	$result_count = mysqli_query($database,"SELECT COUNT(*) As total_records FROM `zamowienia`");
	...
	$second_last = $total_no_of_pages - 1; // total page minus 1
		...
		// Pobieranie zamowien
	$zap2 = "SELECT * FROM zamowienia ORDER BY id_zamowienia LIMIT $offset, $total_records_per_page";
		...
		<br><br><br>
			...
			<div class="center">
				...
				<select class="select" id="get_val" name="Select_id_stat" required>  
						...
						<?php 
							$i = 0;
							while($length_zam_all!=$i){
								print_r("<option>".$id_zam_all[$i]."</option>  "); 
								$i++;
							}
						?>
					</select><br><br>
