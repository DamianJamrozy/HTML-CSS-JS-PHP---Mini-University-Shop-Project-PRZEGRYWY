...
<body style="overflow:hidden; color:white;">
		...
		<div id="container">
			<center><font size="4px">Wersje gier:</font><br><br></center>
...
<th style='width:150px;'>Typ wersji</th>
</tr>
</thead>
<tbody>
<?php
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $result = mysqli_query($database,"SELECT * FROM `wersje` LIMIT $offset, $total_records_per_page");
    while($row = mysqli_fetch_array($result)){
		echo "<tr>
			  <td>".$row['id_wersji']."</td>
			  <td>".$row['typ_wersji']."</td>
		   	  </tr>";
        }
    ...
    <?php if($page_no < $total_no_of_pages){
		...
		<div class="left">
			<form method="POST" action="../../php/root.php">
				...
				<h3>Dodaj wersję:</h3><br>
				
				<input type="text" placeholder="nazwa wersji" class="btn_buy" name="Select_name" style='text-transform:none;'><br><br>
				
					
				<input type="submit" value="Dodaj" class="btn_buy" name="add_version">
		...
		<div class="center">
			<form method="POST" action="../../php/root.php">
				...
				<h3>Edytuj wersję:</h3><br>
				<select class="select" id="get_val" name="Select_id_stat" required>  
						<option>Wybierz typ wersji</option>  
						<?php 
							$i = 0;
							while($length_ver!=$i){
								print_r("<option>".$typ_wersji[$i]."</option>  "); 
								$i++;
							}
						?>
					</select><br><br>
				<input type="text" placeholder="nazwa wersji" class="btn_buy" name="Select_stat" style='text-transform:none;'><br><br>
				
					
				<input type="submit" value="Edytuj" class="btn_buy" name="edit_version">
		...
		<div class="right">
			<form method="POST" action="../../php/root.php">
				...
				<input type="submit" class="btn_buy" value="Usuń" name="delete_version"><br><br>
			</form>
		</div>
