...
<body style="overflow:hidden; color:white;">
		...
		<div id="container">
			<center><font size="4px">Zamówienia - Sklep:</font><br><br></center>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
	...
	$result_count = mysqli_query($database,"SELECT COUNT(*) As total_records FROM `zamowienia` WHERE id_dostawy=2 AND id_statusu=1 OR id_dostawy=2 AND id_statusu=2 OR id_dostawy=2 AND id_statusu=3 OR id_dostawy=2 AND id_statusu=4 OR id_dostawy=2 AND id_statusu=7");
	...
	$second_last = $total_no_of_pages - 1; // total page minus 1
		...
		// Pobieranie zamowien
	$zap2 = "SELECT * FROM zamowienia WHERE id_dostawy=2 AND id_statusu=1 OR id_dostawy=2 AND id_statusu=2 OR id_dostawy=2 AND id_statusu=3 OR id_dostawy=2 AND id_statusu=4 OR id_dostawy=2 AND id_statusu=7 LIMIT $offset, $total_records_per_page";
			...
			<form method="POST" action="../../php/root.php">
				...
				<select class="select" id="get_val" name="Select_id_stat" required>  
						...
						<?php 
							$i = 0;
							while($length_zamY!=$i){
								print_r("<option>".$id_zamY[$i]."</option>  "); 
								$i++;
							}
						?>
					</select><br><br>
