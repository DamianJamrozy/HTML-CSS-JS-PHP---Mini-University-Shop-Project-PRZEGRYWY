...
<body style="overflow:hidden; color:white;">
		...
		<div id="container">
			<center><font size="4px">Studia:</font><br><br></center>
...
<th style='width:150px;'>Nazwa studia</th>
</tr>
</thead>
<tbody>
<?php
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
	...
	$result_count = mysqli_query($database,"SELECT COUNT(*) As total_records FROM `studia`");
	$total_records = mysqli_fetch_array($result_count);
	$total_records = $total_records['total_records'];
    $total_no_of_pages = ceil($total_records / $total_records_per_page);
	$second_last = $total_no_of_pages - 1; // total page minus 1

    $result = mysqli_query($database,"SELECT * FROM `studia` LIMIT $offset, $total_records_per_page");
    while($row = mysqli_fetch_array($result)){
		echo "<tr>
			  <td>".$row['id_studia']."</td>
			  <td>".$row['nazwa_studia']."</td>
		   	  </tr>";
        }
    ...
    <?php if($page_no < $total_no_of_pages){
		...
		<div class="left">
			<form method="POST" action="../../php/root.php">
				...
				<h3>Dodaj studio:</h3><br>
				
				<input type="text" placeholder="nazwa_studia" class="btn_buy" name="Select_name" style='text-transform:none;'><br><br>
					
				<input type="submit" value="Dodaj" class="btn_buy" name="add_studio">
		...
		<div class="center">
			<form method="POST" action="../../php/root.php">
				...
				<h3>Edytuj nazwę studia:</h3><br>
				<select class="select" id="get_val" name="Select_id_stat" required>  
						<option>Wybierz nazwę studia</option>  
						<?php 
							$i = 0;
							while($length_stud!=$i){
				...
				<input type="text" placeholder="nazwa_studia" class="btn_buy" name="Select_stat" style='text-transform:none;'><br><br>
					
				<input type="submit" value="Edytuj" class="btn_buy" name=edit_studio>
		...
		<div class="right">
			<form method="POST" action="../../php/root.php">
				...
				<input type="submit" class="btn_buy" value="Usuń" name="delete_studio"><br><br>
			</form>
		</div>
